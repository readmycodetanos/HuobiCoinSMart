 ...
 * ================================================
 */
public abstract class BodyRequestAbstract<T, R extends BodyRequestAbstract> extends RequestAbstract<T, R> implements OnHasBody<R> {
    ...
    public BodyRequestAbstract(String url) {
        super(url);
    }
