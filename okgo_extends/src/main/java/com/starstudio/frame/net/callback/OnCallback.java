...
import com.starstudio.frame.net.convert.OnConverter;
 ...
 */
public interface OnCallback<T> extends OnConverter<T> {

    /** 请求网络开始前，UI线程 */
    void onStart(RequestAbstract<T, ? extends RequestAbstract> abstractRequest);
