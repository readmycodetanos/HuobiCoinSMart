 ...
 */
package com.starstudio.frame.net.model;
...
import com.starstudio.frame.net.utils.IOUtils;
...
public class Progress implements Serializable {
    ...
    public RequestAbstract<?, ? extends RequestAbstract> abstractRequest;   //网络请求
    ...
    public static ContentValues buildContentValues(Progress progress) {
        ...
        values.put(REQUEST, IOUtils.toByteArray(progress.abstractRequest));
    ...
    public static Progress parseCursorToBean(Cursor cursor) {
        ...
        progress.abstractRequest = (RequestAbstract<?, ? extends RequestAbstract>) IOUtils.toObject(cursor.getBlob(cursor.getColumnIndex(Progress.REQUEST)));
