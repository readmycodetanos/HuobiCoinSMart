...
public class FirstCacheRequestPolicy<T> extends BaseCachePolicy<T> {
    public FirstCacheRequestPolicy(RequestAbstract<T, ? extends RequestAbstract> abstractRequest) {
    ...
    @Override
    public void requestAsync(final CacheEntity<T> cacheEntity, OnCallback<T> OnCallback) {
