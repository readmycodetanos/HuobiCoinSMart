 ...
 */
package com.starstudio.frame.net.convert;
 ...
 * ================================================
 */
public class FileConvert implements OnConverter<File> {
    ...
    private com.starstudio.frame.net.callback.OnCallback<File> OnCallback;        //下载回调
    ...
    public void setOnCallback(com.starstudio.frame.net.callback.OnCallback<File> onCallback) {
    ...
    private void onProgress(final Progress progress) {
        HttpUtils.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                OnCallback.downloadProgress(progress);   //进度回调的方法
            }
        });
    }
}
