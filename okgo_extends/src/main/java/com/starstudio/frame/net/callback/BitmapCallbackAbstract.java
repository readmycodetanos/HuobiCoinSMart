...
import com.starstudio.frame.net.convert.BitmapConvert;
 ...
 * ================================================
 */
public abstract class BitmapCallbackAbstract extends CallbackAbstract<Bitmap> {

    private BitmapConvert convert;

    public BitmapCallbackAbstract() {
        convert = new BitmapConvert();
    }

    public BitmapCallbackAbstract(int maxWidth, int maxHeight) {
        convert = new BitmapConvert(maxWidth, maxHeight);
    }

    public BitmapCallbackAbstract(int maxWidth, int maxHeight, Bitmap.Config decodeConfig, ImageView.ScaleType scaleType) {
