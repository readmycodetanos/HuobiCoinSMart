...
public class ProgressRequestBody<T> extends RequestBody {
    ...
    private com.starstudio.frame.net.callback.OnCallback<T> OnCallback;
    private UploadInterceptor interceptor;

    ProgressRequestBody(RequestBody requestBody, com.starstudio.frame.net.callback.OnCallback<T> OnCallback) {
    ...
    private void onProgress(final Progress progress) {
        HttpUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (OnCallback != null) {
                    OnCallback.uploadProgress(progress);
                }
            }
        });
    }
