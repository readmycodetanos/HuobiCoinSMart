 ...
 */
package com.starstudio.frame.net.exception;
...
public class CacheException extends Exception {
    ...
    public static CacheException nonOrExpire(String cacheKey) {
        return new CacheException("cacheKey = " + cacheKey + " ,can't find cache by cacheKey, or cache has expired!");
    }

    public static CacheException nonAnd304(String cacheKey) {
